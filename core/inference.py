...
from sam3d_objects.pipeline.training_pipeline_pointmap import TrainingSSPipeline
...
def load_model(config_file: str, device: str = 'cpu', compile: bool = False):
    ...
    config._target_ = "sam3d_objects.pipeline.inference_pipeline_pointmap.TrainingSSPipeline"
    check_hydra_safety(config, WHITELIST_FILTERS, BLACKLIST_FILTERS)
