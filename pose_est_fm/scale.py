...
Copied verbatim from pose_est/scale.py so pose_est_fm stays free of the
FoundationPose import chain. PnP assumes a metrically-scaled 3D model, so this
scale must be applied to the mesh before any matching-based pose estimation.
"""
import numpy as np
